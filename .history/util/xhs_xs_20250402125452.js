...
function init() {
        ...
        document.createElement = function(arr){
            // console.log('document.createElement ' ,arr )
            return canvas
        };
        localStorage ={
            getItem:function(){}
...
function getxs(cook , c  , a ) {
    
    document.cookie = cook
    init()
    // c='/api/cas/customer/web/service-ticket'
    // a = {
    ...
    // }
    return JSON.stringify (window._webmsxyw(c,a))
    
}
module.exports = getxs;

// cook = "abRequestId=1ba8685e-babd-5376-b991-929507284048; webBuild=4.61.1; xsecappid=xhs-pc-web; a1=195f4968016t04i9umhqxs89vsghxvgys9nlgics450000167547; webId=3e9611dc08fdd967cd650e1b8262eb5b; gid=yj2i4jKYDdMqyj2i4jKY8j3SyK9843j76xACIM4MYjhMk128xChkvk888yKW24W8W82YfD82; websectiga=2845367ec3848418062e761c09db7caf0e8b79d132ccdd1a4f8e64a11d0cac0d; sec_poison_id=9c686d34-bdc7-43af-879e-a88dcaee6cef; unread={%22ub%22:%2267ca8e53000000002803e4b5%22%2C%22ue%22:%2267e643e4000000001c03daa0%22%2C%22uc%22:38}; loadts=1743568391516"
// c='/api/sns/web/v1/user/follow'
// a = {
//     "target_user_id":"67e7e5cc000000000a03c9b4"
// }

// var a = getxs(cook,c,a)
// console.log(a )
