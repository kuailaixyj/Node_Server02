...
router.get('/', async function (req, res, next) {
  ...
  let {name,sex,CardId,start,end,occupation,phone,city} = req.query



let b= `<html lang="en" style="font-size: 17.0667px; --status-bar-height: 0px; --top-window-height: 0px; --window-left: 0px; --window-right: 0px; --window-margin: 0px; --tab-bar-height: 50px; --window-top: calc(0px + env(safe-area-inset-top)); --window-bottom: calc(0px + env(safe-area-inset-bottom));"><head>
...
#alink[data-v-6ae23533] {
  ...
  console.log("getsign");
    ...
    if(req.query.type === '1'){
          let a=`<html lang="en" style="font-size: 16.9813px; --status-bar-height: 0px; --top-window-height: 0px; --window-left: 0px; --window-right: 0px; --window-margin: 0px; --tab-bar-height: 50px; --window-top: calc(0px + env(safe-area-inset-top)); --window-bottom: calc(0px + env(safe-area-inset-bottom));"><head>
          <script>if (typeof globalThis === 'undefined') {
        window.globalThis = window
        }</script>
        ...
        */
        ...
        <body data-v-6ae23533="">
          <div id="app" data-v-app=""><uni-app class=""><uni-page data-page="pages/personal/personal" type=""><!----><uni-page-wrapper><uni-page-body data-v-6ae23533=""><uni-view data-v-6ae23533="" class="content" style="margin-left: 1.875rem; margin-right: 1.875rem;"><!-- 		<up-navbar  left-icon="close" leftIconSize="18px"
                ...
                @leftClick="backmy" 
                z-index="1001" placeholder fixed>
          </up-navbar> --><!-- X下面的boRDER --><!-- <up-gap  height="1" bg-color="#f7f7f7" margin-top="0" margin-bottom="0"></up-gap> --><uni-view data-v-6ae23533="" class="big-title" style="display: flex; justify-content: center; align-items: center; margin: 3.75rem 0px;"><uni-text data-v-6ae23533="" style="font-size: 1.5625rem; font-weight: bold;"><span>个人信息</span></uni-text></uni-view><uni-view data-v-6ae23533="" class="item-information" style="width: 100%; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" style="color: rgb(127, 127, 127); margin-bottom: 0.3125rem; font-size: 0.9375rem;">证件信息</uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">姓名</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">${name}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">性别</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${sex}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">国籍</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">中国</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件类型</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">居民身份证</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件号</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">${CardId}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件有效期开始</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${start}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件有效期结束</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${end}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: 1.71875rem; width: 100%; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" style="color: rgb(127, 127, 127); margin-bottom: 0.3125rem; font-size: 0.9375rem;">其他信息</uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">职业类型</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${occupation}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">地址</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${city}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view data-v-6ae23533="" class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" data-v-6ae23533="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">手机号</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-6ae23533=""><!----></uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view data-v-6ae23533="" class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${phone}</uni-view></uni-view><uni-view data-v-3677f292="" data-v-6ae23533="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" data-v-6ae23533="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view data-v-6ae23533="" class="UpdateName" style="display: flex; justify-content: center; align-items: center; margin-top: 3.375rem; margin-bottom: 4.6875rem; padding-bottom: 1.875rem;"><!-- <text style="color: #65779e; font-size: 30rpx;"  >更新实名</text> --><!-- <a ref="alink" href="https://tenpay.wechatpay.cn/cgi-bin/mmpayweb-bin/payrenameshow?" class=""></a> --><a data-v-6ae23533="" id="alink" href="https://tenpay.wechatpay.cn/cgi-bin/mmpayweb-bin/payrenameshow?">更新实名</a></uni-view><!-- <a id="alink" href="https://tenpay.wechatpay.cn/cgi-bin/mmpayweb-bin/payrenameshow?">更新实名</a> --></uni-view></uni-page-body></uni-page-wrapper></uni-page><uni-tabbar class="uni-tabbar-bottom" style="display: none;"><div class="uni-tabbar" style="background-color: rgb(255, 255, 255); backdrop-filter: none;"><div class="uni-tabbar-border" style="background-color: rgba(0, 0, 0, 0.33);"></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/wechat.png"></div><div class="uni-tabbar__label" style="color: rgb(25, 190, 107); font-size: 11px; line-height: normal; margin-top: 3px;">微信</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/contact.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">通讯录</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/find.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">发现</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/my.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">我</div><!----></div></div></div><div class="uni-placeholder" style="height: 50px;"></div></uni-tabbar></uni-app></div>
          <script type="module" src="/main.js?t=1725500651004"></script>


        </body></html>`
        fs.writeFileSync(path.join(__dirname, '/') + '01.js', "let a=\`"+ b+ "\`;" + 
        "\n $done({body:a});")
        res.sendFile( path.join(__dirname, '/') + '01.js')
    }else if(req.query.type === '2'){
              let a = `<!DOCTYPE html>
        <html data-id="2230945389745946" data-mode="idc" >
        <head lang="en">
            
              <script src="https://gtimg.wechatpay.cn/resource/xres/build/fe_monitor/xmonitor-sdk/v2.5.6/monitor.min.js" crossorigin="anonymous"></script>
              <script>
                window.commonXmonitor = new Monitor({"actionUrl":"https://log.wechatpay.cn/xdc/xmtpayappreport/report/action","envUrl":"https://log.wechatpay.cn/xdc/xmtpayappreport/report/env","logUrl":"https://log.wechatpay.cn/xdc/xmtpayappreport/report/log","resourceUrl":"https://log.wechatpay.cn/xdc/xmtpayappreport/report/resource","performanceUrl":"https://log.wechatpay.cn/xdc/xmtpayappreport/report/performance"});
              </script>
          ...
          <script>
                ...
                function report(keypoint, msg) {
                  var TEST_UID = 'BgAAyfYCeiCKw3LCg2k1qwdzzEC0TC8GR3kJHc0=';
                  var noExportkeyUa = encodeURIComponent(navigator.userAgent);
                  var pageUrl = encodeURIComponent(window.location.href);
                  var pageId = window.location.pathname;
                  var uid = getCookie('wxp_log_uid') || TEST_UID;
                  var noExportkeyUrl = 'https://log.weixin.qq.com/mmpayfereport/report/reportcgi?module=' + 'bindCard_h5' + '&page_id=' + pageId + '&type=keypoint&uid=' + encodeURIComponent(uid);
                  var noExportkeyReportUrl = noExportkeyUrl + '&ua=' + noExportkeyUa + '&key_point=' + keypoint + '&page_url=' + pageUrl + '&common_log=' + encodeURIComponent(msg || '');
                  setTimeout(function () {
                    new Image().src = noExportkeyReportUrl;
                  }, 201);
                }

                // 白屏检测
                try {
                  var initErrorDetections = [];
                  [500,1000,1500,2000,2500,3000,4000,5000,6000,7000,8000].forEach(function (t, idx) {
                    var timer = window.setTimeout(function () {
                      var documentReady = document;
                      var appRootNode = document.querySelector('#pages');
                      if (documentReady && appRootNode && appRootNode.children && appRootNode.children.length) {
                        initErrorDetections.forEach(function (detection) {
                          window.clearTimeout(detection);
                        });
                        report('mmpayweb_H5.LOAD_SUCCESS.' + t);
                        return;
                      }
                      report('mmpayweb_H5.BLANK_SCREEN.' + t);
                    }, t);
                    initErrorDetections.push(timer);
                  });
                } catch (err) {
                  console.error(err);
                }
            ...
            <title></title>
            <link rel="stylesheet" href="//gtimg.wechatpay.cn/resource/wxpayuserinfo/others/assets/res/weui/0.2.0/weui.min.css">
            <link rel="stylesheet" href="//gtimg.wechatpay.cn/resource/wxpayuserinfo/others/assets/res/weui/2.0.1/weui.min.css">

            <script>
                window.server={
                    initData:{"retcode":"0","retmsg":"GetUinByExportKey ret=0","session_id":"050949530668369a186066111625216258","status_data":{"operation":"1","retcode":"0","balance":1276681,"retmsg":"ok","cannot_condition_array":[{"type":9,"desc":"解除自动扣费协议以后再试。","title":"有自动扣费业务生效中","key":"解除","appid":"wxbd687630cd02ce1d","path":"pages/ContractManagement/Index.html?business=ContractList&source_id=14|14"},{"type":23,"desc":"请先关闭微信支付分后再试。","title":"微信支付分尚未关闭","key":"关闭","appid":"wxd8f3793ea3b935b8","path":"/pages/use/closewxvalue.html"},{"type":99,"desc":"可消费或提现。","title":"账户有零钱余额￥12766.81","key":"提现"}],"optional_condition_array":[{"type":29,"url":"https://wx.tenpay.com/userroll/readtemplate?t=userroll/index_tmpl&type=userrollexport","desc":"如有需要，可通过导出账单进行保留。","title":"账单及零钱明细将被清空","key":"导出账单"},{"type":2,"desc":"系统将为你清空当前账户的绑卡信息。","title":"解绑所有银行卡"},{"type":103,"desc":"如果已开启“允许通过手机号向我转账”开关，将为你关闭。","title":"关闭手机号转账功能"}],"is_reg":"1","true_name":"${name}","mask_name":"${name}","card_type":"2","cre_type":"1","bind_card_list":[{"IsSaveYfq":"0","bank_flag":"1","bank_name":"民生银行","bank_phone":"95568","bank_type":"CMBC_DEBIT","bankacc_type":"1","bind_day_quota":"5000000","bind_once_quota":"5000000","bind_serial":"903229563500000000010929776896","bind_tail":"9931","day_quota_1":"300000","day_quota_3":"10000000","expired_flag":"0","mobile":"134******24","once_quota_1":"300000","once_quota_3":"10000000","bank_card_tag":"1","bind_icharacter4":"1","support_micropay":1,"support_save":"1","support_fetch":"1","draw_available":"2","draw_type":"1","export_start":"0","export_end":"16","draw_status":"SR^Y|T0^Y|T1^Y","maintain_starttime":"","maintain_endtime":"","mobile_area":"+86","support_intl_sms":1,"bind_state":1,"bind_version":"2019-03-22 03:13:55","fetch_limit_array":[],"fetch_limit_recommend_bind_serial":[],"related_credit_instal_plan_group":[],"instal_state":0,"instal_minimum_fee":0,"instal_protocol_ver":""}],"only_unreg_by_pwd":false},"banner":{},"rename_faq_list":[]}
                }
            </script>
            <script src="//gtimg.wechatpay.cn/resource/wxpayuserinfo/others/assets/res/js/jweixin-1.0.0.js"></script>
            <script src="//gtimg.wechatpay.cn/resource/wxpayuserinfo/others/assets/res/zepto/1.1.6/zepto.js"></script>
            <script src="//gtimg.wechatpay.cn/resource/wxpayuserinfo/others/assets/res/weuijs/1.2.1/weui.min.js"></script>
            <script>
                var WXPAY_JSLOG_REPORT_CONF={
                    name: "mmpayweb_H5",
                    exportKeyType:"wxpay_unreg"
                };
                var WXPAY_JSLOG_REPORT = {
                    report:function(){},
                    log:function(){},
                    send:function(){}
                };
                var reportOnload = function(){
                    setTimeout(function () {
                        (new Image()).src = 'https://support.weixin.qq.com/cgi-bin/mmsupport-bin/reportforweb?rid=123210&rkey=31&rvalue=1';
                    }, 201);
                };
                var reportError = function () {
                    setTimeout(function () {
                        (new Image()).src = 'https://support.weixin.qq.com/cgi-bin/mmsupport-bin/reportforweb?rid=123210&rkey=32&rvalue=1';
                    }, 201);
                };
            </script>
            <script type="text/javascript" charset="UTF-8" src="//gtimg.wechatpay.cn/static/cdn/wxpay-fe-report/report/report.min.0.0.44.js" crossOrigin="anonymous" onload="reportOnload()" onerror="reportError()"></script>
        </head>
        <body>
        <div id="index-banner" class="banner" style="display: none;">
        </div>
        <div id="pages">

        </div>

        <script src="//gtimg.wechatpay.cn/resource/wxpayuserinfo/wepay-rename/24081601/rename/bundle.js?timestamp=1724061338435" crossOrigin></script>
