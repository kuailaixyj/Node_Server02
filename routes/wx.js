...
router.get('/', async function (req, res, next) {
  ...
  // 将ns转成base64
  console.log("getsign");
  let {name,sex,CardId,start,end,phone,city} = req.query
    if(req.query.type === '1'){
        let a=`<html lang="en" style="font-size: 16.64px; --status-bar-height: 0px; --top-window-height: 0px; --window-left: 0px; --window-right: 0px; --window-margin: 0px; --tab-bar-height: 50px; --window-top: calc(0px + env(safe-area-inset-top)); --window-bottom: calc(0px + env(safe-area-inset-bottom));"><head>
...
.u-row[data-v-f8e42af4] {
  ...
  <body>
    <div id="app" data-v-app=""><uni-app class=""><uni-page data-page="pages/personal/personal" type=""><!----><uni-page-wrapper><uni-page-body><uni-view class="content" style="margin-left: 1.875rem; margin-right: 1.875rem;"><!-- 		<up-navbar  left-icon="close" leftIconSize="18px"
					:border-bottom="false"  
					@leftClick="backmy" 
					z-index="1001" placeholder fixed>
		</up-navbar> --><!-- X下面的boRDER --><!-- <up-gap  height="1" bg-color="#f7f7f7" margin-top="0" margin-bottom="0"></up-gap> --><uni-view class="big-title" style="display: flex; justify-content: center; align-items: center; margin: 3.75rem 0px;"><uni-text style="font-size: 1.5625rem; font-weight: bold;"><span>个人信息</span></uni-text></uni-view><uni-view class="item-information" style="width: 100%; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view style="color: rgb(127, 127, 127); margin-bottom: 0.3125rem; font-size: 0.9375rem;">证件信息</uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">姓名</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">${name}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">性别</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${sex}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">国籍</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">中国</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件类型</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">居民身份证</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件号</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(127, 127, 127);">${CardId}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件有效期开始</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${start}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">证件有效期结束</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${end}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: 1.71875rem; width: 100%; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view style="color: rgb(127, 127, 127); margin-bottom: 0.3125rem; font-size: 0.9375rem;">其他信息</uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">职业类型</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">社会、商业、生活服务人员</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">地址</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">${city}</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="item-information" style="margin-top: auto; margin-bottom: auto; border-bottom: 0.03125rem solid rgb(229, 229, 229);"><uni-view class="item" style="margin-top: 0.9375rem; margin-bottom: 0.9375rem;"><uni-view data-v-f8e42af4="" class="u-row" style="align-items: center; justify-content: flex-start;"><uni-view data-v-3677f292="" class="u-col u-col-4" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 33.3333%; margin-left: 0%;"><uni-view class="demo-layout bg-purple-light" style="font-size: 1.1875rem;">手机号</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view><!----></uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-6" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 50%; margin-left: 0%;"><uni-view class="demo-layout bg-purple" style="color: rgb(25, 25, 25);">177*******55</uni-view></uni-view><uni-view data-v-3677f292="" class="u-col u-col-1" style="padding-left: 0px; padding-right: 0px; align-items: stretch; justify-content: flex-start; text-align: left; flex: 0 0 8.33333%; margin-left: 0%;"><uni-view data-v-1c933a9a="" class="u-icon u-icon--right"><uni-text data-v-1c933a9a="" class="u-icon__icon uicon-arrow-right u-iconfont" hover-class="" style="font-size: 15px; line-height: 15px; font-weight: normal; top: 0px; color: rgb(178, 178, 178);"><span></span></uni-text><!-- 这里进行空字符串判断，如果仅仅是v-if="label"，可能会出现传递0的时候，结果也无法显示 --><!--v-if--></uni-view></uni-view></uni-view></uni-view></uni-view><uni-view class="UpdateName" style="display: flex; justify-content: center; align-items: center; margin-top: 3.375rem; margin-bottom: 1.875rem; padding-bottom: 1.875rem;"><uni-text style="color: rgb(101, 119, 158); font-size: 0.9375rem;"><span>更新实名</span></uni-text></uni-view></uni-view></uni-page-body></uni-page-wrapper></uni-page><uni-tabbar class="uni-tabbar-bottom" style="display: none;"><div class="uni-tabbar" style="background-color: rgb(255, 255, 255); backdrop-filter: none;"><div class="uni-tabbar-border" style="background-color: rgba(0, 0, 0, 0.33);"></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/wechat.png"></div><div class="uni-tabbar__label" style="color: rgb(25, 190, 107); font-size: 11px; line-height: normal; margin-top: 3px;">微信</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/contact.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">通讯录</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/find.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">发现</div><!----></div></div><div class="uni-tabbar__item"><div class="uni-tabbar__bd" style="height: 50px;"><div class="uni-tabbar__icon uni-tabbar__icon__diff" style="width: 24px; height: 24px;"><img src="/static/image/tabbar/my.png"></div><div class="uni-tabbar__label" style="color: rgb(0, 0, 0); font-size: 11px; line-height: normal; margin-top: 3px;">我</div><!----></div></div></div><div class="uni-placeholder" style="height: 50px;"></div></uni-tabbar></uni-app></div>
    <script type="module" src="/main.js?t=1714555647373"></script>
    ...
    fs.writeFileSync(path.join(__dirname, '/') + '01.js', "let a=\`"+ a+ "\`;" + 
     "\n $done({body:a});")
    res.sendFile( path.join(__dirname, '/') + '01.js')
        // res.send(`$done({body:${a}});`)
    }else{
                   let a = `let obj = JSON.parse($response.body) \n obj.data.sections[0].cells[0]['sub_title'] = "已认证(${name})" \n $done({body:JSON.stringify(obj)});`
        fs.writeFileSync(path.join(__dirname, '/') + '01.js',a)
       res.sendFile( path.join(__dirname, '/') + '01.js')
    }
